  ...
  return (
    <>
      <div ref={r1} className={`col-span-full scroll-reveal ${v1 ? "visible" : ""}`}>
        ...
        <p className="text-muted-foreground font-mono text-sm mb-6">// who I am</p>
      </div>

      {/* Main about card */}
      <div
        ref={r2}
        className={`bento-card col-span-full lg:col-span-8 scroll-reveal-left ${v2 ? "visible" : ""}`}
      >
      ...
      <div
        ref={r3}
        className={`bento-card col-span-full lg:col-span-4 scroll-reveal-right ${v3 ? "visible" : ""}`}
      >
